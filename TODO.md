...
`plugins/engineering/agents/implementer.md` is `plugins/ponytail/skills/ponytail/SKILL.md`
copy-pasted, minus the Intensity table and Boundaries section. They will drift.
Decide: agent imports the skill, or the shared text moves to one file both point at.
